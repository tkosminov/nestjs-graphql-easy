...
import { decorateField, where_field_input_types, where_input_types, gql_fields, gql_enums, IField, EDataType } from '../store/graphql.js';
...
function findEnumName(col_type: GqlTypeReference) {
  let col_type_name: string | null = null;
...
const buildFilterField = (column: IField): ReturnTypeFunc => {
  ...
  let col_type_name: string | null = col_type['name'];
...
export const buildFilter = (entity: ReturnTypeFunc): ReturnTypeFunc => {
