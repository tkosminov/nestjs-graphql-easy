...
import { decorateField, order_field_input_types, order_input_types, gql_fields, IField, registerEnumType } from '../store/graphql.js';
...
export const buildOrder = (entity: ReturnTypeFunc): ReturnTypeFunc => {
